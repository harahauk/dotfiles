# Requires permissions to run with a permissive policy likke RemoteSigned, Unrestricted or Bypass
# Set-ExecutionPolicy RemoteSigned -Scope CurrentUser
# Must be ran as administator
# Note: There's an interesting group policy to change that, but thats for later
# TODO: Since propably running as administrator, use runas or similar for the correct user
#ssh-keygen if .ssh/id_rsa does not exist
git submodule init
